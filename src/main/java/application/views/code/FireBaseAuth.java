...
public class FireBaseAuth {
    ...
    protected FireBaseAuth() {
       firebaseKey = "AIzaSyBHDOPAvvd_7WGlKentUvyJb-wTFb5FRZY";
    }
    ...
    public JsonObject getAccountInfo(String token) throws Exception {
        ...
        try {
            ...
            user = rootobj.get("users").getAsJsonArray().get(0).getAsJsonObject();
